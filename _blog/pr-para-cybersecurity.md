...
tags:
  - "PR para cybersecurity"
  - "segurança digital"
  - "comunicação de crise"
  - "PR para empresa de tecnologia"
primary_keyword: "PR para cybersecurity"
keyword_cluster:
  - "assessoria de imprensa para cybersecurity"
  - "comunicação para empresa de segurança digital"
  - "PR para cibersegurança"
  - "vazamento de dados comunicação"
  - "segurança da informação imprensa"
  - "relatório de ameaças digitais"
  - "porta-voz em segurança cibernética"
  - "Digital PR para cybersecurity"
pain_points:
...
channels:
  - "imprensa de tecnologia"
  - "imprensa de negócios"
  - "SEO técnico"
  - "LinkedIn de especialistas"
  - "relatórios de ameaça"
  - "comunicação de crise"
metrics:
