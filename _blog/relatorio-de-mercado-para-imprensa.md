...
primary_keyword: "relatório de mercado para imprensa"
keyword_cluster:
  - "pesquisa proprietária para imprensa"
  - "estudo de mercado para PR"
  - "relatório de tendências para marca"
  - "dados para assessoria de imprensa"
  - "Digital PR Brasil"
  - "backlinks em jornais"
  - "conteúdo com dados para SEO"
  - "pauta com pesquisa proprietária"
pain_points:
